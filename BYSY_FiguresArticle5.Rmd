...
ggplot(featROI)+
	...
	geom_text(data=featROI%>% filter(type %in% c("chromBY")),aes(x=(pmax(start,start(ROI))+pmin(end,end(ROI)))/2,y=0.5,label=featname),col="black")+
...
ggsave(plot=pp,paste0("FigArticle/Fig5.pdf"),h=14,w=10)
...
ggsave(plot=pp,paste0("FigArticle/FigS5AD.pdf"),h=14,w=10)
...
ggsave(plot=pp,paste0("FigArticle/FigS5EH.pdf"),h=14,w=10)
...
ggsave(plot=pp,paste0("FigArticle/FigS5IL.pdf"),h=14,w=10)
...
ggsave(plot=pp,paste0("FigArticle/FigS5M.pdf"),h=14,w=10)
