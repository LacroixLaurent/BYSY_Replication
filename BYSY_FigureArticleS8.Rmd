...
### Figure S8: plot test classification biblio
...
pp2 <- (p_CTF19 | p_FKH1FKH2 | p_RIF1 | p_RIF1RBM)  + plot_layout(guides='collect')+plot_annotation(title="Supplementary Figure 8",theme=theme(plot.title = element_text(face="bold")))


quartz(file=paste0("FigArticle/FigS8.pdf"),height=4,width=12,type="pdf")
pp2
dev.off()
```
