...
quartz(file=paste0("FigArticle/FigS9.pdf"),height=4,width=6,type="pdf")
plo+plot_annotation(title="Supplementary Figure 9",theme=theme(plot.title = element_text(face="bold")))
dev.off()
```
